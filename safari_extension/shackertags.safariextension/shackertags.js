...
(function() {
  ...
  add_tag_form = (function() {
    ...
    add_tag_form.prototype.save = function() {
      ...
      if (localStorage.shackertags === void 0 || localStorage.shackertags == "") {
        tags = {};
      } else {
        tags = JSON.parse(localStorage.shackertags);
      }
      ...
      localStorage.shackertags = JSON.stringify(tags);
      author_add_tag_nodes = $(".add_tag." + (this.parent.get_author_id()));
      _.each(author_add_tag_nodes, function(add_tag_node) {
  ...
  st_shacker_tag = (function() {
    ...
    st_shacker_tag.prototype.process_existing_tags = function() {
      ...
      existing_tags = JSON.parse(localStorage.shackertags)[author_id];
    ...
    st_shacker_tag.prototype.remove_tag = function(author_id, tag, tag_node) {
      ...
      var existing_tags, tag_to_remove, tags;
      tags = JSON.parse(localStorage.shackertags);
      existing_tags = tags[author_id];
      ...
      tags[author_id].splice(existing_tags.indexOf(tag_to_remove), 1);
      localStorage.shackertags = JSON.stringify(tags);
    };
